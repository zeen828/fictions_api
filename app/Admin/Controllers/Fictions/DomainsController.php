...
namespace App\Admin\Controllers\Fictions;
...
class DomainsController extends AdminController
{
    ...
    protected function form()
    {
        ...
        $form->select('species', __('fictions.domain.species'))->options(['1' => '動態主體', '2' => 'APK下載'])->default(1)->required();
        $form->radio('ssl', __('fictions.domain.ssl'))->options(['0' => '無', '1' => '加密'])->default(0)->required();
        $form->radio('power', __('fictions.domain.power'))->options(['0' => '一般', '1' => '高權'])->default(0);
        $form->text('domain', __('fictions.domain.domain'))->required();
        ...
        $form->saved(function (Form $form) {
            $species = $form->model()->species;
            // Redis 清除
            $redisKey = sprintf('domain_byspecies%d_all', $species);
